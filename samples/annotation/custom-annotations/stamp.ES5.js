  ...
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        var b = (p.prototype = l.prototype = Object.create(h));
        function m(t) {
        ...
        return (
          (v.prototype = b.constructor = p),
          (p.constructor = v),
          (v.displayName = d(p, 'GeneratorFunction')),
          (t.isGeneratorFunction = function(t) {
            var n = 'function' == typeof t && t.constructor;
            return !!n && (n === v || 'GeneratorFunction' === (n.displayName || n.name));
          }),
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, p) : ((t.__proto__ = p), d(t, 'GeneratorFunction')), (t.prototype = Object.create(b)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
          ...
          (A.prototype = {
            ...
            finish: function(t) {
              for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                ...
                if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), P(r), s;
              }
            },
            catch: function(t) {
              for (var n = this.tryEntries.length - 1; n >= 0; --n) {
